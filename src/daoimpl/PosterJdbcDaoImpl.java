...
public class PosterJdbcDaoImpl implements JdbcDao {
	...
	public int getFind_PK() {
		...
		try (Connection con = connectionMaker.makeConnection();
				 PreparedStatement pstmt = con.prepareStatement("select max(poster_Id) from poster_table");
	...
	public int getCount() {
		...
		try (Connection con = connectionMaker.makeConnection();
				 PreparedStatement pstmt = con.prepareStatement("select count(poster_Id) from poster_table");
				 ResultSet resultSet = pstmt.executeQuery()) {
